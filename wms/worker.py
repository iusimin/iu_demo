...
from wms.server import IUWMSBackendService
from wms.server import ConfigParser
from wms.server import CONFIG_FILE as SERVER_CONFIG_FILE
...
def main():
    ...
    application = IUWMSBackendService(app_options)
    application.connect()
